...
ags="generate -i modules/openapi-generator/src/test/resources/2_0/petstore.yaml -g typescript-fetch -c bin/typescript-fetch-petstore-multiple-query-params.json -o samples/client/petstore/typescript-fetch/builds/multiple-query-params $@"
